...
<div class="box">
    ...
    <ul class="list">
        ...
        <ul class="list">
          ...
          <li class="item">블록체인 트랜잭션 감지 및 이벤트 스레드풀 동작 구현</li>
          <li class="item">기타 CRUD 기능 구현 기능 구현</li>
...
| 활동명                                                              | 설명                                                                                                                                              | 기간              |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [알고리즘 스터디](https://github.com/ksh103/Algorithm-Study-Reboot) | 정기적 알고리즘 풀이 모임 스터디                                                                                                                  | 2022.07 ~ 2023.01 |
